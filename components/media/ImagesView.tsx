        ...
        {imagesMessages.map((message) => {
          ...
          return (
            <a
              ...
              className="group relative aspect-square rounded-lg overflow-hidden bg-[rgba(255,255,255,0.05)] hover:ring-2 hover:ring-white/30 transition-all cursor-pointer"
            >
              <Image
                src={file.url}
                alt={fileName}
